...
FLAGS="-std=c++11 $MODE_FLAGS --js-library library_ppapi.js --pre-js deplug.js --pre-js ppapi.js --post-js wrappers/base.js --post-js wrappers/url_loader.js --post-js wrappers/graphics_2d.js --post-js wrappers/view.js -I$NACL_SDK_ROOT/include"
